...
export default function handleError(error, path) {
  ...
  switch (true) {
    ...
    default:
      ...
      B.error(`[app-bo/helpers/handleError()] This type of error can't be processed. This should never happen.`, '❌')
      B.error(`[app-bo/helpers/handleError()] Error Type: ${typeof error}`, '❌')
      B.error(`[app-bo/helpers/handleError()] Error Constructor: ${getErrorConstructorName(error)}`, '❌')
